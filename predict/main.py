...
def load_mydata():
    drug_vec = load_vec("feature/rep_drug.txt")
    protein_vec = load_vec("feature/rep_protein.txt")
...
def load_data():
    ...
    np.savetxt(r'H:\EFMSDTI\predict\idx1.txt', idx1)
    np.savetxt(r'H:\EFMSDTI\predict\idx2.txt', idx2)
    np.savetxt(r'H:\EFMSDTI\predict\idx3.txt', idx3)
...
if __name__=="__main__":
    ...
    X,Y=load_data()
    np.savetxt(r'H:\EFMSDTI\predict\X.txt', X)
    ...
    for train_index, test_index in kf.split(X, Y):
        ...
        #         Y_predict.append((Y_test,1))
        #     else:
        #         Y_predict.append((Y_test,0))
        # Y_predict.append(Y_pred)
        # np.savetxt(r'F:\anaconda\predict\predictions2.txt', Y_pred)
        ...
        np.savetxt(r'F:\anaconda\predict\score\Ytest.txt', Y_test)
